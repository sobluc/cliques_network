...
def fraccion_comp_gigante_Kronecker_5(gamma):
    ...
    # A = -8 * gamma**3 + 6 * gamma ** 4
    # B = (4 * gamma ** 6) / ((27/2) * gamma ** 8 - 10 * gamma **9 + (3/2) * np.sqrt(3 * gamma**16*(27 - 40 * gamma + 16 * gamma**2)))
    # C = 2**(2/3) * (27 * gamma ** 8 -20 *  gamma **9+ 3 * np.sqrt(3) *  np.sqrt(3 * gamma**16*(27 - 40 * gamma + 16 * gamma**2)))
